...
Recorded Lecture: [11_24_20](https://drive.google.com/file/d/1RuWpDjT3tj1wJPz3sYelAzWTtOAvNH0p/view?usp=sharing)
...
* <b>Balanced Binary Tree:</b> For any two leaf nodes, the difference of depth is at most one
...
* A node’s index with respect to its parent and children can be generalized as:
	* A node’s <b>parent</b> index: node_position // 2 
	* A node’s <b>left child</b> index: 2 * node_position
	* A node’s <b>right child</b> index: 2 * node_position + 1
...
3. While new root is less than one of its children
